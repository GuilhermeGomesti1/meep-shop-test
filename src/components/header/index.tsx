...
export default function Header() {
  const { cartItems } = useCartContext(); // Acesse os itens do carrinho

  return (
    <header className="flex justify-center items-center bg-gradient-to-r from-[#36008F] to-[#CF0A8B] shadow-md sticky top-0 z-100 h-16">
